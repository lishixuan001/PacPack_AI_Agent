...
"""
Autograder for Phase 1 of PacPack
"""
...
LAYOUT_SEED = [543, 953, 345, 235, 6546, 4656, 7365, 367, 453, 132]
baselineScores = [399, 462, 451, 407, 460, 442, 367, 528, 405, 537]
...
def readCommand( argv ):
  ...
  parser.add_option('-p', '--pacman', help=default('Pacman team'),
                    default='phase1Team') # TODO: Think about if we should leave this default
  ...
  pacmanAgents = loadAgents(True, 'phase1Team', nokeyboard, {})
